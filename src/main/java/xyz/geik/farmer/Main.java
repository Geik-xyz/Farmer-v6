...
import xyz.geik.farmer.integrations.shopguiplus.ShopGuiHook;
...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		if (getServer().getPluginManager().getPlugin("ShopGUIPlus") != null) {
			getServer().getPluginManager().registerEvents(new ShopGuiHook(), this);
			getLogger().info("ShopGui+ support added. Farmer will update prices according to ShopGui+ if available.");
		}
	}
